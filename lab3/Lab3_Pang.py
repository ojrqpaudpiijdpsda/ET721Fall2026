...
name1 = name.upper()
name2 = name.lower()
name3 = name.replace('Micheal', 'Janet')
...
#define the patten to search for
pattern = r"Smith"
#use the search() function to search for the patten in the string
result = re.search(pattern, s1)
#print result
print(f'The patten result is = {result}')
if result:
    print("Match found")
else:
...
print(f"Year of the The bodyguard = {release_year_dict['The bodyguard']}")
...
print(album1 | album2)
#difference, ^, returns the elements that are in set but not in both sets
print(album1 ^ album2)
